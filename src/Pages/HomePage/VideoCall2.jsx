...
export default function VideoCall2() {
  ...
  return (
<div className="h-[100dvh] w-screen flex flex-col bg-gradient-to-br  z-50 from-purple-800 via-indigo-700 via-blue-600 to-sky-500 text-white relative overflow-hidden">
